...
/// The delegate object with type <code>FUIWelcomeControllerDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUIBasicAuthenticationDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUICalendarViewDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUIDocumentPickerAttachmentActionDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUIDynamicAuthenticationDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUIEULADelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUIOnboardingScanViewControllerDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
///
/// \endcode<h2>Attention</h2>
/// The delegate object with type <code>FUIPasscodeControllerDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during its whole execution scope.
...
/// text-align: NSTextAlignment;
/// <h2>Attention</h2>
/// The delegate object with type <code>FUIUserConsentViewControllerDelegate</code> is declared as a weak reference. So on deallocation it will be automatically set to nil. To keep it alive as expected, developer should retain the delegate object during the whole execution scope.
